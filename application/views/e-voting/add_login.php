    	...
    	<div class="col-md-4 col-md-offset-4 top">
          ...
          <?php endif; ?>
			  	...
			  	<div class="panel-body">
			    	<form accept-charset="UTF-8" role="form" method="post" action="<?php echo base_url(); ?>Autharization/addlogin">
              ...
              <div class="form-group">
			    			<input class="form-control" placeholder=" Enter Your Full Name" name="full_name" type="text" value="">
			    		</div>
			    		
			    		<input class="btn btn-lg btn-success btn-block" type="submit" name="add_login" value="Login">
			    	</fieldset>
			      	</form>
			    </div>
			</div>

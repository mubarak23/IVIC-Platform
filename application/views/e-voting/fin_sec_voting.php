...
<div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-2">
           ...
           <div class="panel panel-default">
                      <div class="panel-heading">Financial Secetary </div>
                  ...
                  <?php foreach( $fin_sec_candidate as $canditate): ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="">
                        <span class="">
                          <form method="post" action="<?php echo base_url(); ?>Evoting/fin_sec_vote">
                            ...
                            <input type="submit" name="fin_sec_vote" class="btn btn-lg btn-primary" value="Vote">
                          </form>
                        </span>
                      </div>

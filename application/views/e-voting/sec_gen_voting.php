...
<div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-2">
                   ...
                   <div class="panel panel-default">
                      <div class="panel-heading">Secetary General  </div>
                  ...
                  <?php foreach( $sec_gen_candidate as $canditate): ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="">
                        <span class="">
                          <form method="post" action="<?php echo base_url(); ?>Evoting/sec_gen_vote">
                            ...
                            <input type="submit" name="sec_gen_vote" class="btn btn-lg btn-primary" value="Vote">
                          </form>
                        </span>
                      </div>

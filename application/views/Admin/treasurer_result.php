						...
						<div class="block">
                            ...
                            <section>
                              <div class="panel panel-default">
                                ...
                                <div class="panel-heading">Treasurer Candidate</div>
                                ...
                                <table class="table table-striped">
                                  ...
                                  <tr>
                                  <?php if($treasurer_position_1): ?>
                                    <td><h3><?php echo $treasurer_position_1->id; ?></h3></td>
                                   <td><h3><?php echo $treasurer_position_1->student_id?></h3></td>
                                   <td><h3><?php echo $treasurer_position_1->full_name; ?></h3></td>
                                    <td><h3>Treasurer</h3></td>
                                    <td><h3><?php echo $vote_count_treasurer_1; ?></h3></td>

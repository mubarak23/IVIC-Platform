						...
						<div class="block">
                            ...
                            <section>
                              <div class="panel panel-default">
                                ...
                                <div class="panel-heading">Asist. Financial Secretary</div>
                                ...
                                <table class="table table-striped">
                                  ...
                                  <tr>
                                  <?php if($asis_fin_sec_position_1): ?>
                                    <td><h3><?php echo $asis_fin_sec_position_1->id; ?></h3>
                                    </td>
                                   <td><h3><?php echo $asis_fin_sec_position_1->student_id?>
                                   </h3></td>
                                   <td><h3><?php echo $asis_fin_sec_position_1->full_name; ?>
                                   </h3></td>
                                    <td><h3>Asist. Financial Secretary</h3></td>
                                    <td><h3><?php echo $vote_count_asis_fin_sec_1; ?></h3></td>
                                </tr>
                                 <?php endif; ?>

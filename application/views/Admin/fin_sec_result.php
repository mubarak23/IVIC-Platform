						...
						<div class="block">
                            ...
                            <section>
                              <div class="panel panel-default">
                                ...
                                <div class="panel-heading">Financial Candidate</div>
                                ...
                                <table class="table table-striped">
                                  ...
                                  <tr>
                                  <?php if($fin_sec_position_1): ?>
                                    <td><h3><?php echo $fin_sec_position_1->id; ?></h3></td>
                                   <td><h3><?php echo $fin_sec_position_1->student_id?></h3></td>
                                   <td><h3><?php echo $fin_sec_position_1->full_name; ?></h3></td>
                                    <td><h3>Financial Secretary</h3></td>
                                    <td><h3><?php echo $vote_count_fin_sec_1; ?></h3></td>

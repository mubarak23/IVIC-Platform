 ...
 Class Admin_model extends CI_model{
	 ...
	 public function Ev_index(){
		 ...
		 public function add_student($data){
		 	...
		 	$insert = $this->db->insert('all_students', $data);
	...
	public function ev_admin_login($email, $password){
		 ...
		 public function update_student($id, $data){
		 		$this->db->where('id', $id);
		 		$this->db->update('all_students', $data);
		...
		public function add_asis_fin_sec($data){
				$insert = $this->db->insert('asis_fin_sec_cand', $data);
 	...
 	public function add_pro_II($data){
		 	$insert = $this->db->insert('pro_II_cand', $data);
		 ...
		 public function add_academic($data){
		 	$insert = $this->db->insert('academic_cand', $data);
	...
	public function add_sales($data){
				$insert = $this->db->insert('sales_cand', $data);

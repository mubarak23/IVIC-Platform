                              ...
                              <div class="panel panel-default">
                                ...
                                <table class="table table-striped">
                                  ...
                                  <?php if($asis_sec_gen_position_1): ?>
                                    <td><?php echo $asis_sec_gen_position_1->id; ?></td>
                                   <td><?php echo $asis_sec_gen_position_1->student_id?></td>
                                   <td><?php echo $asis_sec_gen_position_1->full_name; ?></td>
                                    <td>Asis. Secetary General</td>
                                    <td><?php echo $vote_count_asis_sec_1; ?></td>
                                </tr>

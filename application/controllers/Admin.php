...
class Admin extends CI_Controller {
	...
	// adding contestant for the post of asist. financial sec
	public function asis_fin_sec_candidate(){

					

		if(isset($_POST['asis_fin_sec'])){
			...
			$this->form_validation->set_rules('position', 'Position', 'required|trim');
				...
				$add_candidate = $this->Admin_model->add_asis_fin_sec($data);
	...
	public function proII_candidate(){

					

		if(isset($_POST['pro_II'])){
			...
			$this->form_validation->set_rules('position', 'Position', 'required|trim');
				...
				$add_candidate = $this->Admin_model->add_pro_II($data);
		...
		public function academic_candidate(){
		...
		if(isset($_POST['academic'])){
			...
			$this->form_validation->set_rules('position', 'Position', 'required|trim');
				...
				$add_candidate = $this->Admin_model->add_academic($data);
	...
	public function sales_candidate(){
		...
		if(isset($_POST['sales'])){
			...
			$this->form_validation->set_rules('position', 'Position', 'required|trim');
				...
				$add_candidate = $this->Admin_model->add_sales($data);
